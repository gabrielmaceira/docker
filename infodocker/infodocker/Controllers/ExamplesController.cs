...
using infodocker.Models;

namespace infodocker.Controllers
{
    public class ExamplesController : Controller
    {
        private readonly infodockerContext _context;

        public ExamplesController(infodockerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Birthday,Phone")] Example example)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Birthday,Phone")] Example example)
        {
            if (id != example.Id)
            {
                return NotFound();
